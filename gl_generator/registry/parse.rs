...
pub fn to_rust_ty<T: AsRef<str>>(ty: T) -> Cow<'static, str> {
    let ty = match ty.as_ref().trim() {
        ...
        "void *" => "*mut __gl_imports::c_void",
        "void **" => "*const *mut __gl_imports::c_void",
        ...
        "const void*" | "const void *" => "*const __gl_imports::c_void",
        "const void **" => "*const *const __gl_imports::c_void",
        "const void *const*" => "*const *const __gl_imports::c_void",
        ...
        "float" => "__gl_imports::c_float",
        "int" => "__gl_imports::c_int",
        "int64_t" => "i64",
        "unsigned int" => "__gl_imports::c_uint",
        "unsigned long" => "__gl_imports::c_ulong",
        // "void "                     => "()",
        ...
        "const char *" => "*const __gl_imports::c_char",
        "const int *" => "*const __gl_imports::c_int",
        // "const void *"              => "*const __gl_imports::c_void",
        "int *" => "*mut __gl_imports::c_int",
        "int32_t *" => "*mut i32",
        "int64_t *" => "*mut i64",
        "long *" => "*mut __gl_imports::c_long",
        "unsigned int *" => "*mut __gl_imports::c_uint",
        "unsigned long *" => "*mut __gl_imports::c_ulong",
        // "void *"                    => "*mut __gl_imports::c_void",
        ...
        // "const char *"              => "*const __gl_imports::c_char",
        // "const int *"               => "*const __gl_imports::c_int",
        "float *" => "*mut __gl_imports::c_float",
        // "int *"                     => "*mut __gl_imports::c_int",
        // "unsigned long *"           => "*mut __gl_imports::c_ulong",
        // "void *"                    => "*mut __gl_imports::c_void",
        ...
        "const struct AHardwareBuffer *" => "*const __gl_imports::c_void", // humm
        "char *" => "*const __gl_imports::c_char",
        "struct wl_buffer *" => "*const __gl_imports::c_void",
        "struct wl_display *" => "*const __gl_imports::c_void",
        "struct wl_resource *" => "*const __gl_imports::c_void",
