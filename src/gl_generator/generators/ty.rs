...
pub fn to_rust_ty(ecx: &ExtCtxt, ty: &str) -> P<ast::Ty> {
    let hack_in_lieu_of_rust_19387_being_merged = match ty {
        // gl.xml types
        "GLDEBUGPROC"               => quote_expr!(ecx, x as types::GLDEBUGPROC),
        "GLDEBUGPROCAMD"            => quote_expr!(ecx, x as types::GLDEBUGPROCAMD),
        "GLDEBUGPROCARB"            => quote_expr!(ecx, x as types::GLDEBUGPROCARB),
        "GLDEBUGPROCKHR"            => quote_expr!(ecx, x as types::GLDEBUGPROCKHR),
        "GLbitfield"                => quote_expr!(ecx, x as types::GLbitfield),
        "GLboolean"                 => quote_expr!(ecx, x as types::GLboolean),
        "GLbyte"                    => quote_expr!(ecx, x as types::GLbyte),
        "GLclampd"                  => quote_expr!(ecx, x as types::GLclampd),
        "GLclampf"                  => quote_expr!(ecx, x as types::GLclampf),
        "GLclampx"                  => quote_expr!(ecx, x as types::GLclampx),
        "GLdouble"                  => quote_expr!(ecx, x as types::GLdouble),
        "GLeglImageOES"             => quote_expr!(ecx, x as types::GLeglImageOES),
        "GLenum"                    => quote_expr!(ecx, x as types::GLenum),
        "GLfixed"                   => quote_expr!(ecx, x as types::GLfixed),
        "GLfloat"                   => quote_expr!(ecx, x as types::GLfloat),
        "GLhalfNV"                  => quote_expr!(ecx, x as types::GLhalfNV),
        "GLhandleARB"               => quote_expr!(ecx, x as types::GLhandleARB),
        "GLint"                     => quote_expr!(ecx, x as types::GLint),
        "GLint64EXT"                => quote_expr!(ecx, x as types::GLint64EXT),
        "GLintptr"                  => quote_expr!(ecx, x as types::GLintptr),
        "GLintptrARB"               => quote_expr!(ecx, x as types::GLintptrARB),
        "GLshort"                   => quote_expr!(ecx, x as types::GLshort),
        "GLsizei"                   => quote_expr!(ecx, x as types::GLsizei),
        "GLsizeiptr"                => quote_expr!(ecx, x as types::GLsizeiptr),
        "GLsizeiptrARB"             => quote_expr!(ecx, x as types::GLsizeiptrARB),
        "GLsync"                    => quote_expr!(ecx, x as types::GLsync),
        "GLubyte"                   => quote_expr!(ecx, x as types::GLubyte),
        "GLuint"                    => quote_expr!(ecx, x as types::GLuint),
        "GLuint64"                  => quote_expr!(ecx, x as types::GLuint64),
        "GLuint64EXT"               => quote_expr!(ecx, x as types::GLuint64EXT),
        "GLushort"                  => quote_expr!(ecx, x as types::GLushort),
        "GLvdpauSurfaceNV"          => quote_expr!(ecx, x as types::GLvdpauSurfaceNV),
        "void "                     => quote_expr!(ecx, x as __gl_imports::libc::c_void),
        "GLboolean *"               => quote_expr!(ecx, x as *mut types::GLboolean),
        "GLchar *"                  => quote_expr!(ecx, x as *mut types::GLchar),
        "GLcharARB *"               => quote_expr!(ecx, x as *mut types::GLcharARB),
        "GLdouble *"                => quote_expr!(ecx, x as *mut types::GLdouble),
        "GLenum *"                  => quote_expr!(ecx, x as *mut types::GLenum),
        "GLfixed *"                 => quote_expr!(ecx, x as *mut types::GLfixed),
        "GLfloat *"                 => quote_expr!(ecx, x as *mut types::GLfloat),
        "GLhandleARB *"             => quote_expr!(ecx, x as *mut types::GLhandleARB),
        "GLint *"                   => quote_expr!(ecx, x as *mut types::GLint),
        "GLint64 *"                 => quote_expr!(ecx, x as *mut types::GLint64),
        "GLint64EXT *"              => quote_expr!(ecx, x as *mut types::GLint64EXT),
        "GLsizei *"                 => quote_expr!(ecx, x as *mut types::GLsizei),
        "GLubyte *"                 => quote_expr!(ecx, x as *mut types::GLubyte),
        "GLuint *"                  => quote_expr!(ecx, x as *mut types::GLuint),
        "GLuint [2]"                => quote_expr!(ecx, x as *mut [types::GLuint, ..2]),
        "GLuint64 *"                => quote_expr!(ecx, x as *mut types::GLuint64),
        "GLuint64EXT *"             => quote_expr!(ecx, x as *mut types::GLuint64EXT),
        "GLushort *"                => quote_expr!(ecx, x as *mut types::GLushort),
        "GLvoid *"                  => quote_expr!(ecx, x as *mut types::GLvoid),
        "GLvoid **"                 => quote_expr!(ecx, x as *const *mut types::GLvoid),
        "void *"                    => quote_expr!(ecx, x as *mut __gl_imports::libc::c_void),
        "void **"                   => quote_expr!(ecx, x as *const *mut __gl_imports::libc::c_void),
        "const GLboolean *"         => quote_expr!(ecx, x as *const types::GLboolean),
        "const GLbyte *"            => quote_expr!(ecx, x as *const types::GLbyte),
        "const GLchar *"            => quote_expr!(ecx, x as *const types::GLchar),
        "const GLcharARB *"         => quote_expr!(ecx, x as *const types::GLcharARB),
        "const GLclampf *"          => quote_expr!(ecx, x as *const types::GLclampf),
        "const GLdouble *"          => quote_expr!(ecx, x as *const types::GLdouble),
        "const GLenum *"            => quote_expr!(ecx, x as *const types::GLenum),
        "const GLfixed *"           => quote_expr!(ecx, x as *const types::GLfixed),
        "const GLfloat"             => quote_expr!(ecx, x as types::GLfloat),
        "const GLfloat *"           => quote_expr!(ecx, x as *const types::GLfloat),
        "const GLhalfNV *"          => quote_expr!(ecx, x as *const types::GLhalfNV),
        "const GLint *"             => quote_expr!(ecx, x as *const types::GLint),
        "const GLint64EXT *"        => quote_expr!(ecx, x as *const types::GLint64EXT),
        "const GLintptr *"          => quote_expr!(ecx, x as *const types::GLintptr),
        "const GLshort *"           => quote_expr!(ecx, x as *const types::GLshort),
        "const GLsizei *"           => quote_expr!(ecx, x as *const types::GLsizei),
        "const GLsizeiptr *"        => quote_expr!(ecx, x as *const types::GLsizeiptr),
        "const GLubyte *"           => quote_expr!(ecx, x as *const types::GLubyte),
        "const GLuint *"            => quote_expr!(ecx, x as *const types::GLuint),
        "const GLuint64 *"          => quote_expr!(ecx, x as *const types::GLuint64),
        "const GLuint64EXT *"       => quote_expr!(ecx, x as *const types::GLuint64EXT),
        "const GLushort *"          => quote_expr!(ecx, x as *const types::GLushort),
        "const GLvdpauSurfaceNV *"  => quote_expr!(ecx, x as *const types::GLvdpauSurfaceNV),
        "const GLvoid *"            => quote_expr!(ecx, x as *const types::GLvoid),
        "const void *"              => quote_expr!(ecx, x as *const __gl_imports::libc::c_void),
        "const void **"             => quote_expr!(ecx, x as *const *const __gl_imports::libc::c_void),
        "const void *const*"        => quote_expr!(ecx, x as *const *const __gl_imports::libc::c_void),
        "const GLboolean **"        => quote_expr!(ecx, x as *const *const types::GLboolean),
        "const GLchar **"           => quote_expr!(ecx, x as *const *const types::GLchar),
        "const GLcharARB **"        => quote_expr!(ecx, x as *const *const types::GLcharARB),
        "const GLvoid **"           => quote_expr!(ecx, x as *const *const types::GLvoid),
        "const GLchar *const*"      => quote_expr!(ecx, x as *const *const types::GLchar),
        "const GLvoid *const*"      => quote_expr!(ecx, x as *const *const types::GLvoid),
        "struct _cl_context *"      => quote_expr!(ecx, x as *const types::_cl_context),
        "struct _cl_event *"        => quote_expr!(ecx, x as *const types::_cl_event),

        // glx.xml types
        "Bool"                      => quote_expr!(ecx, x as types::Bool),
        "Colormap"                  => quote_expr!(ecx, x as types::Colormap),
        "DMbuffer"                  => quote_expr!(ecx, x as types::DMbuffer),
        "Font"                      => quote_expr!(ecx, x as types::Font),
        "GLXContext"                => quote_expr!(ecx, x as types::GLXContext),
        "GLXContextID"              => quote_expr!(ecx, x as types::GLXContextID),
        "GLXDrawable"               => quote_expr!(ecx, x as types::GLXDrawable),
        "GLXFBConfig"               => quote_expr!(ecx, x as types::GLXFBConfig),
        "GLXFBConfigSGIX"           => quote_expr!(ecx, x as types::GLXFBConfigSGIX),
        "GLXPbuffer"                => quote_expr!(ecx, x as types::GLXPbuffer),
        "GLXPbufferSGIX"            => quote_expr!(ecx, x as types::GLXPbufferSGIX),
        "GLXPixmap"                 => quote_expr!(ecx, x as types::GLXPixmap),
        "GLXVideoCaptureDeviceNV"   => quote_expr!(ecx, x as types::GLXVideoCaptureDeviceNV),
        "GLXVideoDeviceNV"          => quote_expr!(ecx, x as types::GLXVideoDeviceNV),
        "GLXVideoSourceSGIX"        => quote_expr!(ecx, x as types::GLXVideoSourceSGIX),
        "GLXWindow"                 => quote_expr!(ecx, x as types::GLXWindow),
        // "GLboolean"                 => quote_expr!(ecx, x as types::GLboolean),
        // "GLenum"                    => quote_expr!(ecx, x as types::GLenum),
        // "GLint"                     => quote_expr!(ecx, x as types::GLint),
        // "GLsizei"                   => quote_expr!(ecx, x as types::GLsizei),
        // "GLuint"                    => quote_expr!(ecx, x as types::GLuint),
        "Pixmap"                    => quote_expr!(ecx, x as types::Pixmap),
        //"Status"                    => quote_expr!(ecx, x as types::Status),
        //"VLNode"                    => quote_expr!(ecx, x as types::VLNode),
        //"VLPath"                    => quote_expr!(ecx, x as types::VLPath),
        //"VLServer"                  => quote_expr!(ecx, x as types::VLServer),
        "Window"                    => quote_expr!(ecx, x as types::Window),
        "__GLXextFuncPtr"           => quote_expr!(ecx, x as types::__GLXextFuncPtr),
        "const GLXContext"          => quote_expr!(ecx, x as const types::GLXContext),
        "float "                    => quote_expr!(ecx, x as __gl_imports::libc::c_float),
        "int "                      => quote_expr!(ecx, x as __gl_imports::libc::c_int),
        "int64_t"                   => quote_expr!(ecx, x as i64),
        "unsigned int "             => quote_expr!(ecx, x as __gl_imports::libc::c_uint),
        "unsigned long "            => quote_expr!(ecx, x as __gl_imports::libc::c_ulong),
        // "void "                     => quote_expr!(ecx, x as __gl_imports::libc::c_void),
        "DMparams *"                => quote_expr!(ecx, x as *mut types::DMparams),
        "Display *"                 => quote_expr!(ecx, x as *mut types::Display),
        "GLXFBConfig *"             => quote_expr!(ecx, x as *mut types::GLXFBConfig),
        "GLXFBConfigSGIX *"         => quote_expr!(ecx, x as *mut types::GLXFBConfigSGIX),
        "GLXHyperpipeConfigSGIX *"  => quote_expr!(ecx, x as *mut types::GLXHyperpipeConfigSGIX),
        "GLXHyperpipeNetworkSGIX *" => quote_expr!(ecx, x as *mut types::GLXHyperpipeNetworkSGIX),
        "GLXVideoCaptureDeviceNV *" => quote_expr!(ecx, x as *mut types::GLXVideoCaptureDeviceNV),
        "GLXVideoDeviceNV *"        => quote_expr!(ecx, x as *mut types::GLXVideoDeviceNV),
        // "GLuint *"                  => quote_expr!(ecx, x as *mut types::GLuint),
        "XVisualInfo *"             => quote_expr!(ecx, x as *mut types::XVisualInfo),
        // "const GLubyte *"           => quote_expr!(ecx, x as *GLubyte),
        "const char *"              => quote_expr!(ecx, x as *const __gl_imports::libc::c_char),
        "const int *"               => quote_expr!(ecx, x as *const __gl_imports::libc::c_int),
        // "const void *"              => quote_expr!(ecx, x as *const __gl_imports::libc::c_void),
        "int *"                     => quote_expr!(ecx, x as *mut __gl_imports::libc::c_int),
        "int32_t *"                 => quote_expr!(ecx, x as *mut i32),
        "int64_t *"                 => quote_expr!(ecx, x as *mut i64),
        "long *"                    => quote_expr!(ecx, x as *mut __gl_imports::libc::c_long),
        "unsigned int *"            => quote_expr!(ecx, x as *mut __gl_imports::libc::c_uint),
        "unsigned long *"           => quote_expr!(ecx, x as *mut __gl_imports::libc::c_ulong),
        // "void *"                    => quote_expr!(ecx, x as *mut __gl_imports::libc::c_void),

        // wgl.xml types
        "BOOL"                      => quote_expr!(ecx, x as types::BOOL),
        "DWORD"                     => quote_expr!(ecx, x as types::DWORD),
        "FLOAT"                     => quote_expr!(ecx, x as types::FLOAT),
        // "GLbitfield"                => quote_expr!(ecx, x as types::GLbitfield),
        // "GLboolean"                 => quote_expr!(ecx, x as types::GLboolean),
        // "GLenum"                    => quote_expr!(ecx, x as types::GLenum),
        // "GLfloat"                   => quote_expr!(ecx, x as types::GLfloat),
        ...
        // "GLuint"                    => quote_expr!(ecx, x as types::GLuint),
        // "GLushort"                  => quote_expr!(ecx, x as types::GLushort),
        "HANDLE"                    => quote_expr!(ecx, x as types::HANDLE),
        "HDC"                       => quote_expr!(ecx, x as types::HDC),
        "HENHMETAFILE"              => quote_expr!(ecx, x as types::HENHMETAFILE),
        "HGLRC"                     => quote_expr!(ecx, x as types::HGLRC),
        "HGPUNV"                    => quote_expr!(ecx, x as types::HGPUNV),
        "HPBUFFERARB"               => quote_expr!(ecx, x as types::HPBUFFERARB),
        "HPBUFFEREXT"               => quote_expr!(ecx, x as types::HPBUFFEREXT),
        "HPVIDEODEV"                => quote_expr!(ecx, x as types::HPVIDEODEV),
        "HVIDEOINPUTDEVICENV"       => quote_expr!(ecx, x as types::HVIDEOINPUTDEVICENV),
        "HVIDEOOUTPUTDEVICENV"      => quote_expr!(ecx, x as types::HVIDEOOUTPUTDEVICENV),
        "INT"                       => quote_expr!(ecx, x as types::INT),
        "INT64"                     => quote_expr!(ecx, x as types::INT64),
        "LPCSTR"                    => quote_expr!(ecx, x as types::LPCSTR),
        "LPGLYPHMETRICSFLOAT"       => quote_expr!(ecx, x as types::LPGLYPHMETRICSFLOAT),
        "LPVOID"                    => quote_expr!(ecx, x as types::LPVOID),
        "PGPU_DEVICE"               => quote_expr!(ecx, x as types::PGPU_DEVICE),
        "PROC"                      => quote_expr!(ecx, x as types::PROC),
        "UINT"                      => quote_expr!(ecx, x as types::UINT),
        "VOID"                      => quote_expr!(ecx, x as types::VOID),
        // "int "                      => quote_expr!(ecx, x as __gl_imports::libc::c_int),
        // "unsigned int "             => quote_expr!(ecx, x as __gl_imports::libc::c_uint),
        // "void "                     => quote_expr!(ecx, x as __gl_imports::libc::c_void),
        "BOOL *"                    => quote_expr!(ecx, x as *mut types::BOOL),
        "DWORD *"                   => quote_expr!(ecx, x as *mut types::DWORD),
        "FLOAT *"                   => quote_expr!(ecx, x as *mut types::FLOAT),
        // "GLuint *"                  => quote_expr!(ecx, x as *mut types::GLuint),
        "HANDLE *"                  => quote_expr!(ecx, x as *mut types::HANDLE),
        "HGPUNV *"                  => quote_expr!(ecx, x as *mut types::HGPUNV),
        "HPVIDEODEV *"              => quote_expr!(ecx, x as *mut types::HPVIDEODEV),
        "HVIDEOINPUTDEVICENV *"     => quote_expr!(ecx, x as *mut types::HVIDEOINPUTDEVICENV),
        "HVIDEOOUTPUTDEVICENV *"    => quote_expr!(ecx, x as *mut types::HVIDEOOUTPUTDEVICENV),
        "INT32 *"                   => quote_expr!(ecx, x as *mut types::INT32),
        "INT64 *"                   => quote_expr!(ecx, x as *mut types::INT64),
        "UINT *"                    => quote_expr!(ecx, x as *mut types::UINT),
        "USHORT *"                  => quote_expr!(ecx, x as *mut types::USHORT),
        "const COLORREF *"          => quote_expr!(ecx, x as *const types::COLORREF),
        "const DWORD *"             => quote_expr!(ecx, x as *const types::DWORD),
        "const FLOAT *"             => quote_expr!(ecx, x as *const types::FLOAT),
        // "const GLushort *"          => quote_expr!(ecx, x as *const types::GLushort),
        "const HANDLE *"            => quote_expr!(ecx, x as *const types::HANDLE),
        "const HGPUNV *"            => quote_expr!(ecx, x as *const types::HGPUNV),
        "const LAYERPLANEDESCRIPTOR *"  => quote_expr!(ecx, x as *const types::LAYERPLANEDESCRIPTOR),
        "const LPVOID *"            => quote_expr!(ecx, x as *const types::LPVOID),
        "const PIXELFORMATDESCRIPTOR *" => quote_expr!(ecx, x as *const types::IXELFORMATDESCRIPTOR),
        "const USHORT *"            => quote_expr!(ecx, x as *const types::USHORT),
        // "const char *"              => quote_expr!(ecx, x as *const __gl_imports::libc::c_char),
        // "const int *"               => quote_expr!(ecx, x as *const __gl_imports::libc::c_int),
        "float *"                   => quote_expr!(ecx, x as *mut __gl_imports::libc::c_float),
        // "int *"                     => quote_expr!(ecx, x as *mut __gl_imports::libc::c_int),
        // "unsigned long *"           => quote_expr!(ecx, x as *mut __gl_imports::libc::c_ulong),
        // "void *"                    => quote_expr!(ecx, x as *mut __gl_imports::libc::c_void),

        // elx.xml types
        "khronos_utime_nanoseconds_t"   => quote_expr!(ecx, x as types::khronos_utime_nanoseconds_t),
        "khronos_uint64_t"          => quote_expr!(ecx, x as types::khronos_uint64_t),
        "khronos_ssize_t"           => quote_expr!(ecx, x as types::khronos_ssize_t),
        "EGLNativeDisplayType"      => quote_expr!(ecx, x as types::EGLNativeDisplayType),
        "EGLNativePixmapType"       => quote_expr!(ecx, x as types::EGLNativePixmapType),
        "EGLNativeWindowType"       => quote_expr!(ecx, x as types::EGLNativeWindowType),
        "EGLint"                    => quote_expr!(ecx, x as types::EGLint),
        "EGLint *"                  => quote_expr!(ecx, x as *mut types::EGLint),
        "const EGLint *"            => quote_expr!(ecx, x as *const types::EGLint),
        "NativeDisplayType"         => quote_expr!(ecx, x as types::NativeDisplayType),
        "NativePixmapType"          => quote_expr!(ecx, x as types::NativePixmapType),
        "NativeWindowType"          => quote_expr!(ecx, x as types::NativeWindowType),
        //"Bool"                      => quote_expr!(ecx, x as types::Bool),
        "EGLBoolean"                => quote_expr!(ecx, x as types::EGLBoolean),
        "EGLenum"                   => quote_expr!(ecx, x as types::EGLenum),
        "EGLAttribKHR"              => quote_expr!(ecx, x as types::EGLAttribKHR),
        "EGLAttrib"                 => quote_expr!(ecx, x as types::EGLAttrib),
        "EGLAttrib *"               => quote_expr!(ecx, x as *mut types::EGLAttrib),
        "const EGLAttrib *"         => quote_expr!(ecx, x as *const types::EGLAttrib),
        "EGLConfig"                 => quote_expr!(ecx, x as types::EGLConfig),
        "EGLConfig *"               => quote_expr!(ecx, x as *mut types::EGLConfig),
        "EGLContext"                => quote_expr!(ecx, x as types::EGLContext),
        "EGLDeviceEXT"              => quote_expr!(ecx, x as types::EGLDeviceEXT),
        "EGLDisplay"                => quote_expr!(ecx, x as types::EGLDisplay),
        "EGLSurface"                => quote_expr!(ecx, x as types::EGLSurface),
        "EGLClientBuffer"               => quote_expr!(ecx, x as types::EGLClientBuffer),
        "__eglMustCastToProperFunctionPointerType"  => quote_expr!(ecx, x as types::__eglMustCastToProperFunctionPointerType),
        "EGLImageKHR"               => quote_expr!(ecx, x as types::EGLImageKHR),
        "EGLImage"                  => quote_expr!(ecx, x as types::EGLImage),
        "EGLSyncKHR"                => quote_expr!(ecx, x as types::EGLSyncKHR),
        "EGLSync"                   => quote_expr!(ecx, x as types::EGLSync),
        "EGLTimeKHR"                => quote_expr!(ecx, x as types::EGLTimeKHR),
        "EGLTime"                   => quote_expr!(ecx, x as types::EGLTime),
        "EGLSyncNV"                 => quote_expr!(ecx, x as types::EGLSyncNV),
        "EGLTimeNV"                 => quote_expr!(ecx, x as types::EGLTimeNV),
        "EGLuint64NV"               => quote_expr!(ecx, x as types::EGLuint64NV),
        "EGLStreamKHR"              => quote_expr!(ecx, x as types::EGLStreamKHR),
        "EGLuint64KHR"              => quote_expr!(ecx, x as types::EGLuint64KHR),
        "EGLNativeFileDescriptorKHR"    => quote_expr!(ecx, x as types::EGLNativeFileDescriptorKHR),
        "EGLsizeiANDROID"           => quote_expr!(ecx, x as types::EGLsizeiANDROID),
        "EGLSetBlobFuncANDROID"     => quote_expr!(ecx, x as types::EGLSetBlobFuncANDROID),
        "EGLGetBlobFuncANDROID"     => quote_expr!(ecx, x as types::EGLGetBlobFuncANDROID),
        "EGLClientPixmapHI"         => quote_expr!(ecx, x as types::EGLClientPixmapHI),

        // failure
        _ => panic!("Type conversion not implemented for `{}`", ty),
    };
    match hack_in_lieu_of_rust_19387_being_merged.node {
        ast::ExprCast(_, ref ty) => ty.clone(),
        _ => panic!(),
    }
}
/*
